...
use qubit_codec::{
    TranscodeDecodeEngine, TranscodeDecodeHooks, Transcoder, Codec, DecodeAction,
...
#[test]
#[should_panic]
fn test_transcode_decode_engine_finish_passes_bounded_output_to_hooks() {
