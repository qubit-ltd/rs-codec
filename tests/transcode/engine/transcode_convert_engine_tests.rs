...
impl TranscodeEncodeHooks<ResetEmittingTargetCodec> for ResetTargetHooks {
    fn handle_unencodable_encode(
        ...
        codec::TranscodeEncodeErrorOf<ResetEmittingTargetCodec>,
    > {
    ...
    for FinishOverflowEncodeHooks
{
    fn handle_unencodable_encode(
        ...
        EncodeUnencodableAction<u8>,
        codec::TranscodeEncodeErrorOf<FinishOverflowTargetCodec>,
    > {
        Ok(EncodeUnencodableAction::Reject)
    }
...
impl TranscodeEncodeHooks<ResetFailTargetCodec> for ResetFailTargetHooks {
    fn handle_unencodable_encode(
        ...
        EncodeUnencodableAction<u8>,
        codec::TranscodeEncodeErrorOf<ResetFailTargetCodec>,
    > {
...
impl TranscodeDecodeHooks<SourceCodec> for StrictDecodeHooks {
    fn handle_invalid_decode(
        ...
        codec::TranscodeDecodeErrorOf<SourceCodec>,
    > {
        match error {
...
impl TranscodeDecodeHooks<ShortSourceCodec> for EofIncompleteDecodeHooks {
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<ShortSourceCodec>,
    > {
...
impl TranscodeDecodeHooks<ErrorSourceCodec> for ImpossibleFailureDecodeHooks {
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<ErrorSourceCodec>,
    > {
...
impl TranscodeEncodeHooks<TargetCodec> for PerBatchOverheadEncodeHooks {
    ...
    fn handle_unencodable_encode(
        ...
        EncodeUnencodableAction<u8>,
        codec::TranscodeEncodeErrorOf<TargetCodec>,
    > {
        Err(TranscodeEncodeError::domain_main(
            EngineError::Encode,
            context.input_index(),
...
fn test_buffered_convert_engine_maps_pending_encode_error_before_new_input() {
    ...
    assert!(matches!(
        ...
        TranscodeConvertError::EncodeDomain(
            codec::TranscodeDomainError::Main {
...
fn test_buffered_convert_engine_finish_maps_decode_error() {
    ...
    assert!(matches!(
        ...
        TranscodeConvertError::DecodeDomain(
            codec::TranscodeDomainError::Finish {
...
fn test_buffered_convert_engine_finish_drains_pending_before_decoder_finish_output()
 {
    ...
    assert_eq!(
        codec::TranscodeConvertError::Failure(
            codec::TranscodeFailure::insufficient_output(0, 2, 1)
        ),
        error,
    );
    assert_eq!([0], output);
    ...
    for StatelessResetSourceDecodeHooks
{
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<StatelessResetSourceCodec>,
    > {
        match *error {}
    }
    ...
    for OverflowResetSourceDecodeHooks
{
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<OverflowResetSourceCodec>,
    > {
        match *error {}
    }
}
    ...
    for OverflowResetTargetEncodeHooks
{
    fn handle_unencodable_encode(
        ...
        EncodeUnencodableAction<u8>,
        codec::TranscodeEncodeErrorOf<OverflowResetTargetCodec>,
    > {
    ...
    for MismatchCapacityResetEmittingDecodeHooks
{
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<ResetEmittingSourceCodec>,
    > {
        match *error {}
    }
}
...
fn test_buffered_convert_engine_reset_maps_target_reset_errors() {
    ...
    assert!(matches!(
        error,
        TranscodeConvertError::EncodeDomain(
            codec::TranscodeDomainError::Reset {
    ...
    for ResetEncodingFailSourceDecodeHooks
{
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<ResetEncodingFailSourceCodec>,
    > {
        match *error {}
    }
}
    ...
    for ResetFailSourceDecodeHooks
{
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<ResetFailingSourceCodec>,
    > {
        match error {
            EngineError::Decode | EngineError::Encode => {
                unreachable!("reset path should not produce decode errors")
    ...
    for FinishFailSourceDecodeHooks
{
    fn handle_invalid_decode(
        ...
        DecodeInvalidAction<u8>,
        codec::TranscodeDecodeErrorOf<FinishFailingSourceCodec>,
    > {
        match error {
            EngineError::Decode | EngineError::Encode => {
